...
```{r 306-98, message=FALSE, warning=FALSE, include=FALSE}
...
```{r 306-99, message=FALSE, warning=FALSE, include=FALSE}
# Read in base model construction rmd to continue with 3.6
