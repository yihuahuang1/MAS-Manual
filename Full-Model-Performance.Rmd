# 基本面选股策略模型的总结 Fundamental Stock Selection Summary 
...
## 模型选股 Stock Selection  

`TBD`

## 组合回测 Portfolio Simulation (Back-test)  

`TBD`

## 基础&完整模型的比较 Base Model vs. Full Model Comparison 

`TBD`

## 模型和策略设计缺陷 Model & Strategy Drawbacks 

`TBD`

## 利用组合因子优化选股模型 Consideration: Optimization Using Portfolio Performance Factors 
